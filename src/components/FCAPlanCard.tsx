...
import { CreditCard as Edit2, Trash2, Calendar, User, CheckCircle, Clock, AlertCircle } from 'lucide-react';
...
export function FCAPlanCard({ plan, onEdit, onDelete, isDeleting }: FCAPlanCardProps) {
  const statusConfig = {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow overflow-hidden h-full flex flex-col">
      ...
      {/* Content */}
      <div className="px-6 py-4 flex-1 space-y-3 overflow-y-auto">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div>
            ...
            <div className="flex items-center gap-2 text-gray-900">
              ...
              {new Date(plan.planned_deadline).toLocaleDateString('pt-BR')}
            </div>
          </div>
